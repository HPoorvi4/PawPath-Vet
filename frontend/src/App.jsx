...
function App() {
console.log("PrivateRoute:", typeof PrivateRoute); // should be "function"
console.log("Dashboard:", typeof Dashboard);       // should be "function"
console.log("Appointments:", typeof Appointments); // should be "function"
console.log("Profile:", typeof Profile);           // should be "function"
